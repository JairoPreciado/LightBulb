...
const Programar: React.FC = () => {
  ...
  const saveSchedulesToSubdeviceAndParticle = async (schedules: Record<string, any>) => {
    try {
      ...
      await setDoc(
        userRef,
        { Devices: { ...devices, [deviceKey]: updatedDevice } },
        { merge: true }
      );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.timeInputContainer}>
        <TextInput
          ...
          maxLength={2}
          onChangeText={(text) =>
            setTurnOnTime({ ...turnOnTime, hour: validateInput(text, 23) })
          }
        />
        ...
        <TextInput
          ...
          maxLength={2}
          onChangeText={(text) =>
            setTurnOnTime({ ...turnOnTime, minute: validateInput(text, 59) })
          }
        />
      </View>
      ...
      <View style={styles.timeInputContainer}>
        <TextInput
          ...
          maxLength={2}
          onChangeText={(text) =>
            setTurnOffTime({ ...turnOffTime, hour: validateInput(text, 23) })
          }
        />
        <Text style={styles.separator}>:</Text>
        <TextInput
          ...
          maxLength={2}
          onChangeText={(text) =>
            setTurnOffTime({ ...turnOffTime, minute: validateInput(text, 59) })
          }
        />
      </View>
